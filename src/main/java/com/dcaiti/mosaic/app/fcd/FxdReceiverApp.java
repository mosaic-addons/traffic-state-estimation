...
public abstract class FxdReceiverApp<
    ...
    /**
     * This method shall verify that received {@link FxdUpdate} are of the proper type. Typically, it is sufficient to call
     * {@code message instanceof <UpdateT>} in this method.
     *
     * @param message the received {@link V2xMessage}
     * @return {@code true} if the message is an instance of the specialized {@link FxdUpdate}, else {@code false}
     */
